...
<!-- RUN SCRIPT JUST FOR REFERENCE: -->
PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True python demo_custom.py --model_path src/cut3r_512_dpt_4_64.pth --size 512 --seq_path examples/006 --vis_threshold 1.5 --output_dir tmp_filtered_frames
